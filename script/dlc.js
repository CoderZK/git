 ...
 */
var ajax_url='http://mobile.somochina.com/App/user/api'
var zf_url='http://mobile.somochina.com/App/Personal/api'
var xy_url='http://mobile.somochina.com/app/Users/index'
var xy_user_url='http://mobile.somochina.com/App/Settlement/api'
//
function showMask(){
    $('.mask').remove();
...
function upLoadImg(file,picbox,size){
    ...
    for(var i = 0; i < file.files.length; i++) {
        ...
        if(ext != ".BMP" && ext != ".PNG" && ext != ".GIF" && ext != ".JPG" && ext != ".JPEG") {
            ...
            img_html = "<div class='isImg' style='height: 100%'><img src='" + objUrl + "' onclick='javascript:lookBigImg(this)' style='height: 100%; width: 100%;' /><button class='removeBtn' onclick='javascript:removeImg(this)' style='position:absolute;right: 0;top: 0;background: rgba(0,0,0,0.2);color: #fff;border-radius: 50%;width: 2rem;height: 2rem;font-size: 1.2rem;display: flex;align-items: center;justify-content: center;'>x</button></div>";
